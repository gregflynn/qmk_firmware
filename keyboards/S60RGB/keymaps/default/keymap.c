...
[_FL] = KEYMAP(
  ...
  S(KC_GRV), KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS, RGB_TOG, RGB_HUI, KC_TRNS,  KC_INS,  KC_TRNS, KC_PSCR, KC_HOME,  KC_END, KC_TRNS, \
  KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_MYCM, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, \
  KC_TRNS, KC_TRNS, KC_APP,  KC_CALC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS, \
  KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                             KC_PGUP, KC_HOME, KC_PGDN, KC_END),
};
