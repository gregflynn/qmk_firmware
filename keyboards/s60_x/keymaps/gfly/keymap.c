...
[_BL] = KEYMAP(
  ...
  KC_LSPO, ______,  KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,    KC_N,    KC_M,     KC_COMM, KC_DOT, KC_SLSH, ______,  ______,  KC_RSPC, \
...
[_FL] = KEYMAP(
  ...
  KC_TRNS,   ______,  KC_CAPS, KC_APP,  KC_CALC, KC_TRNS, KC_TRNS, RGB_MOD, KC_MUTE,  KC_MPRV, KC_MNXT, KC_MPLY,  ______, ______,  KC_TRNS, \
